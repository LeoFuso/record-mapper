...
@DisplayName("Local Timestamp with microsecond precision LogicalType unit tests")
@ExtendWith({ SchemaParameterResolver.class, JsonParameterResolver.class })
public class LocalTimestampMicrosTest {
    ...
    void b8aec7e506ce410bb646f517cf71784c(
            @SchemaParameter(location = "local.timestamp.micros.schema.avsc") Schema schema,
            @JsonParameter(location = "local.timestamp/micros/timestamp.long.json") String json
    ) {
        ...
        assertThat(record)
                ...
                .isEqualTo(LocalDateTime.parse("2022-12-18T04:51:55.565970"));
    }
    ...
    void b8aec7e506ce410bb646f517cf71784(
            @SchemaParameter(location = "local.timestamp.micros.schema.avsc") Schema schema,
            @JsonParameter(location = "local.timestamp/micros/timestamp.invalid.long.json") String json
    ) {
    ...
    void b8aec7e506ce410bb646f517cf71784f(
            @SchemaParameter(location = "local.timestamp.micros.schema.avsc") Schema schema,
            @JsonParameter(location = "local.timestamp/micros/timestamp.ISO-8601.json") String json
    ) {
    ...
    void b8aec7e506ce410bb646f517cf71785(
            @SchemaParameter(location = "local.timestamp.micros.schema.avsc") Schema schema,
            @JsonParameter(location = "local.timestamp/micros/timestamp.invalid.ISO-8601.json") String json
    ) {
    ...
    void b8aec7e506ce410bb646f517cf717842(
            @SchemaParameter(location = "local.timestamp.micros.schema.avsc") Schema schema,
            @JsonParameter(location = "local.timestamp/micros/timestamp.zeroed.long.json") String json
    ) {
    ...
    void b8aec7e506ce410bb646f517cf717840(
            @SchemaParameter(location = "local.timestamp.micros.schema.avsc") Schema schema,
            @JsonParameter(location = "local.timestamp/micros/timestamp.null.long.json") String json
    ) {
